#!/usr/bin/env bash
# ==================================================
# Phase 3: Original Menu Style Generator
# Why: ปรับเมนู modular ให้มีหน้าตาแบบ sshplusthai.sh เดิม
#      แต่ยังคงแยกไฟล์แบบ modular ไว้เหมือนเดิม
# ==================================================
...
# Why: สร้าง service helper สำหรับตรวจสถานะ service
create_service_helper() {
  log_info "Creating src/lib/core/service.sh"

  write_file "src/lib/core/service.sh" 644 <<'EOF_SERVICE'
# ==================================================
# Core: Service Helper
...
# Why: สร้าง menu UI แบบสคริปต์เดิม
create_menu_ui() {
  log_info "Creating src/lib/core/menu_ui.sh"

  write_file "src/lib/core/menu_ui.sh" 644 <<'EOF_MENU'
# ==================================================
...
show_menu() {
  ...
  print_row "14" "เคลียร์แรม/Cache    " "00" "ออกจากเมนู         " ""
...
# Why: แทนที่ main.sh ให้ใช้เมนูเดิมและ dispatcher เดิม
create_main() {
...
You should now see the original SSHPlus menu style.

Then commit:

  git add .
  git commit -m "feat(ui): restore original menu style"
